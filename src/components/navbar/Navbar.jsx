  ...
  return (
    <header className=" relative top-0 z-30 w-full px-2 sm:px-4 py-2.5   bg-slate-100  shadow-xl">
      <div className=" flex flex-wrap items-center justify-between mx-auto w-full ">
        ...
        <button
          className="flex-none px-2 inline-flex  lg:hidden"
        ...
        <div
          className={` lg:relative lg:flex lg:flex-row lg:z-0  fixed  ${
            navbar
              ? " h-screen fixed top-0 left-0 z-40  w-64  space-y-6 transform ease-in-out sm:translate-x-0 duration-200 overflow-y-auto bg-slate-100 "
              : ""
          } 
        ...
        `}
          ...
          <form
            className={`max-w-sm  lg:block   ${navbar ? " block" : "hidden"} `}
          >
